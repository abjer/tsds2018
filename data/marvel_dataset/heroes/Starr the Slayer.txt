...
|image = Starr.jpg
|converted = y
|caption = Starr the Slayer, artist [[Barry Windsor-Smith]]
|character_name = Starr the Slayer
|real_name = Starr
|publisher= [[Marvel Comics]]
|debut = ''[[Chamber of Darkness]]'' #4<br> (April, [[1970 in comics|1970]])
|creators = [[Roy Thomas]] (writer)<br>[[Barry Windsor-Smith]] (artist)
|species   = <!-- optional -->
|homeworld = <!-- optional -->
|alliances = <!-- optional -->
|partners  = <!-- optional -->
